...
@Api(tags = "家具展示(干花花艺)的接口")
@SuppressWarnings("all")
public class ShowFurnitureToProListController {
     ...
     */
    @GetMapping("/getAllFurnitureToProList")
    @ApiOperation("干花花艺家具展示的接口")
    @SysLog(BusinessName = "干花花艺家具展示的接口")
    public List<Map<String, String>> getAllFurnitureToProList() {
        //调用业务层获取家具信息的方法,并且返回数据,干花花艺类型
        return showAllFurnitureService.getAllFurnitureToProList();
    }
     ...
     */
    @GetMapping("/getAllFurnitureToProListOrderBy/{value}")
    @ApiOperation("干花花艺家具排序展示的接口")
    @ApiImplicitParam(name = "value", value = "排序的方式")
    @SysLog(BusinessName = "干花花艺家具排序展示的接口")
    public List<Map<String, String>> getAllFurnitureToProListOrderBy(@PathVariable("value") String value) {
        //调用业务层干花花艺家具排序的方法
        return showAllFurnitureService.getAllFurnitureToProListOrderBy(value);
    }
