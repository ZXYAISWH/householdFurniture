...
@Api(tags = "家具展示(抱枕靠垫)的接口")
@SuppressWarnings("all")
public class ShowFurnitureToBzProListController {
     ...
     */
    @GetMapping("/getAllFurnitureToBzProList")
    @ApiOperation("抱枕靠垫家具展示的接口")
    @SysLog(BusinessName = "抱枕靠垫家具展示的接口")
    public List<Map<String, String>> getAllFurnitureToZbProList() {
        //调用业务层获取家具信息的方法,并且返回数据,抱枕靠垫类型
        return showAllFurnitureService.getAllFurnitureToBzProList();
    }
     ...
     */
    @GetMapping("/getAllFurnitureToBzProListOrderBy/{value}")
    @ApiOperation("抱枕靠垫家具排序展示的接口")
    @ApiImplicitParam(name = "value", value = "排序的方式")
    @SysLog(BusinessName = "抱枕靠垫家具排序展示的接口")
    public List<Map<String, String>> getAllFurnitureToProListOrderBy(@PathVariable("value") String value) {
        //调用业务层抱枕靠垫家具排序的方法
        return showAllFurnitureService.getAllFurnitureToBzProListOrderBy(value);
    }
