...
/**
 * 和数据库的f_furniture_property_value表的列对应
 * 用来存储家具属性值的基本数据的
 *
 * @Data 给属性自动生成get和set方法
 * @AllArgsConstructor 自动生成全参构造器
 * @NoArgsConstructor 自动生成无参构造器
 * @ApiModel 描述这是家具属性值表的信息
...
@NoArgsConstructor
@ApiModel("家具属性值表的信息")
@TableName("f_furniture_property_value")
@SuppressWarnings("all")
public class F_furniture_property_value {

    /**
     * 家具属性值详情表的主键
     *
     * @TableId 表示这是主键 列名是property_value_id
     * @ApiModelProperty 描述属性
     */
    @TableId(value = "property_value_id", type = IdType.AUTO)
    @ApiModelProperty("家具属性值详情表的主键")
    private Integer propertyValueId;

    /**
     * 家具的属性:例如:颜色 尺寸
     *
     * @TableField 表示这是表格的列  列名是property_value_title
     * @ApiModelProperty 描述属性
     */
    @TableField(value = "property_value_title")
